...
def _build_portfolio_orchestrator(context: dict) -> PortfolioOrchestrator:
    ...
    generators = {
        ...
        'mean_reversion_v1': _disabled_placeholder,
        'trend_momentum_v1': _disabled_placeholder,
        'breakout_v1': _disabled_placeholder,
    }
    ...
    # Keep per-trade risk capped to 1% for variance survival.
